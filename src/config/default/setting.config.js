...
module.exports = {
  ...
  systemName: 'uGreen Cloud',         //系统名称
  copyright: '2020 ugreen Nas研发部出品',    //copyright
  animate: {                            //动画设置
    disabled: true,                    //禁用动画，true:禁用，false:启用
    name: 'bounce',                     //动画效果，支持的动画效果可参考 ./animate.config.js
    direction: 'left'                   //动画方向，切换页面时动画的方向，参考 ./animate.config.js
  },
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 uGreen Design vue 图标库'}
    {link: 'https://www.lulian.cn', name: '首页'},
    {link: 'https://www.ugreen.com', name: 'uGreen Design'}
  ],
}
